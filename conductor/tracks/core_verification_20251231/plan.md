...
- [ ] Task: 2.2 驗證 EthereumAddress 實作與測試
- [ ] Task: 2.3 驗證 BigInt 工具類實作與測試
- [ ] Task: 2.4 驗證 Hex 編碼工具實作與測試
- [ ] Task: 2.5 驗證 RLP 編碼/解碼實作與測試
- [ ] Task: 2.6 驗證 Bytes 工具類實作與測試
- [ ] Task: 2.7 驗證 Core 模組屬性測試 (Property 24-28)
- [ ] Task: 3. Checkpoint - Core 模組完成 (Update tasks.md)
