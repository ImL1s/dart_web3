...
- [x] Task: 4.4 驗證 BIP-39 助記詞實作與測試
- [x] Task: 4.5 驗證 BIP-32/44 HD 錢包實作與測試
...
- [ ] Task: 6.2 驗證 ABI 類型系統實作與測試
- [ ] Task: 6.3 驗證 ABI 編碼器實作與測試
- [ ] Task: 6.4 驗證 ABI 解碼器實作與測試
- [ ] Task: 6.5 驗證 EIP-712 TypedData 實作與測試
- [ ] Task: 6.6 驗證 ABI JSON 解析器實作與測試
- [ ] Task: 6.7 驗證 Pretty Printer 實作與測試
- [ ] Task: 6.8 驗證 ABI 模組屬性測試 (Property 12-16)
- [ ] Task: 7. Checkpoint - ABI 模組完成 (Update tasks.md)
