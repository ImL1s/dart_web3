...
class AddressLookupTableProgram {
  static final programId =
      PublicKey.fromString('AddressLookupTab1e1111111111111111111111111');
  ...
  static TransactionInstruction createLookupTable({
    ...
    buffer
        .add(Uint8List(4)..buffer.asByteData().setUint32(0, 0, Endian.little));
    // Recent Slot: u64
    ...
    return TransactionInstruction(
      ...
      keys: [
        AccountMeta(
            publicKey: lookupTableAddress, isSigner: false, isWritable: true),
  ...
  static TransactionInstruction extendLookupTable({
    ...
    buffer
        .add(Uint8List(4)..buffer.asByteData().setUint32(0, 2, Endian.little));
    // Address Count: u64
