...
class SolanaTransaction {
  ...
  void sign(List<Ed25519KeyPair> signers) {
    ...
    final newSignatures = List<Uint8List>.filled(requiredSignatures, Uint8List(64));
    ...
    for (final signer in signers) {
      ...
      if (index >= requiredSignatures) {
          throw Exception('Signer is not marked as a required signer in this transaction');
      }
