  ...
  group('Cosmos Mock Integration', () {
    test('getBalances returns correct amounts', () async {
      final mockClient = MockClient((request) async {
        expect(request.url.path, contains('/cosmos/bank/v1beta1/balances/cosmos1address'));
      ...
      final client = CosmosClient('https://api.cosmos.network', httpClient: mockClient);
    ...
    test('broadcastTx posts correct data', () async {
      ...
      final tx = CosmosTx(
          ...
          authInfo: AuthInfo(signerInfos: [], fee: Fee(amount: [], gasLimit: 200000)),
          signatures: [],
      );
