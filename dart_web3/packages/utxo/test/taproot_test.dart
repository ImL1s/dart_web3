...
void main() {
  group('BIP-341 Taproot', () {
    ...
    test('Taproot Tweak (Key Path Spend)', () {
      ...
      final internalKey = HexUtils.decode(
          '00000000000000000000006f8c296684725af9a61f224b74bb0f6c2f5d94713a');
    ...
    test('Taproot Tweak (Script Path Spend)', () {
      ...
      expect(HexUtils.encode(result['outputKey'] as Uint8List),
          isNot(equals(HexUtils.encode(internalKey))));
    });
  });
}
