...
abstract class KeyGenerationCommunicationChannel {
  ...
  Future<void> broadcastMessage(
      String ceremonyId, Map<String, dynamic> message);
...
class HttpKeyGenerationCommunicationChannel
    implements KeyGenerationCommunicationChannel {
  ...
  @override
  Future<void> broadcastMessage(
      String ceremonyId, Map<String, dynamic> message) async {
    // Implementation would send HTTP POST to coordination service
    await Future<void>.delayed(const Duration(milliseconds: 100));
  }
...
class KeyGenerationCeremony {
  ...
  KeyShare _generateKeyShareForParty(
      String partyId, Map<String, Uint8List> masterKeyPair) {
