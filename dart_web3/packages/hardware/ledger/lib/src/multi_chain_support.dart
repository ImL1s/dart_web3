...
class LedgerMultiChainSigner {
  ...
  Uint8List _encodeBitcoinSignRequest(String derivationPath, Uint8List transactionData) {
  ...
  Uint8List _encodeSolanaSignRequest(String derivationPath, Uint8List transactionData) {
    // Simplified Solana signing request encoding
    final pathData = _encodeDerivationPath(derivationPath);
    return Uint8List.fromList([...pathData, ...transactionData]);
  }
  
  Uint8List _encodePolkadotSignRequest(String derivationPath, Uint8List transactionData) {
