...
class FountainDecoder {
  ...
  bool receivePart(FountainPart part) {
    ...
    if (part.fragmentCount != _expectedFragmentCount) {
      throw ArgumentError('Inconsistent fragment count: expected $_expectedFragmentCount, got ${part.fragmentCount}');
    }
    ...
    if (_expectedFragmentCount != null && _solvedFragments.length == _expectedFragmentCount) {
      _isComplete = true;
    }
