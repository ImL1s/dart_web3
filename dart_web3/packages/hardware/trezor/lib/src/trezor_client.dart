...
class TrezorClient {
  ...
  bool get isReady => _state == TrezorConnectionState.connected && _features != null;
  ...
  Future<TrezorAccount> getAccount(String derivationPath, {bool showDisplay = false}) async {
    _ensureConnected();
