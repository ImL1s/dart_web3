...
Uint8List encodeEthereumSignTx({
  required String derivationPath,
...
Uint8List encodeEthereumSignMessage({
  required String derivationPath,
...
Map<String, dynamic> decodeEthereumAddress(Uint8List data) {
...
TrezorSignResponse decodeEthereumMessageSignature(Uint8List data) {
...
ButtonRequest decodeButtonRequest(Uint8List data) {
  // Simplified decoding
...
PinMatrixRequest decodePinMatrixRequest(Uint8List data) {
...
PassphraseRequest decodePassphraseRequest(Uint8List data) {
  return PassphraseRequest(onDevice: false);
}

/// Decode Failure message
String decodeFailure(Uint8List data) {
  // Simplified decoding
