  ...
  group('Chains', () {
    setUp(() {
      ...
      final customChainIds = Chains.getAllChains()
          .where((chain) => ![1, 5, 11155111, 137, 56, 42161, 10, 8453, 43114].contains(chain.chainId))
    ...
    group('predefined chains', () {
      test('should have correct Ethereum mainnet config', () {
        ...
        expect(ethereum.multicallAddress, equals('0xcA11bde05977b3631167028862bE2a173976CA11'));
        expect(ethereum.ensRegistryAddress, equals('0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e'));
      ...
      test('should have correct Goerli testnet config', () {
        ...
        expect(goerli.multicallAddress, equals('0xcA11bde05977b3631167028862bE2a173976CA11'));
        expect(goerli.rpcUrls, isNotEmpty);
        expect(goerli.blockExplorerUrls, contains('https://goerli.etherscan.io'));
      });
      ...
      test('should have correct Sepolia testnet config', () {
        ...
        expect(sepolia.multicallAddress, equals('0xcA11bde05977b3631167028862bE2a173976CA11'));
        expect(sepolia.rpcUrls, isNotEmpty);
        expect(sepolia.blockExplorerUrls, contains('https://sepolia.etherscan.io'));
      });
      ...
      test('should have correct Polygon mainnet config', () {
        ...
        expect(polygon.multicallAddress, equals('0xcA11bde05977b3631167028862bE2a173976CA11'));
      ...
      test('should have correct BSC mainnet config', () {
        ...
        expect(bsc.multicallAddress, equals('0xcA11bde05977b3631167028862bE2a173976CA11'));
      ...
      test('should have correct Arbitrum mainnet config', () {
        ...
        expect(arbitrum.multicallAddress, equals('0xcA11bde05977b3631167028862bE2a173976CA11'));
      ...
      test('should have correct Optimism mainnet config', () {
        ...
        expect(optimism.multicallAddress, equals('0xcA11bde05977b3631167028862bE2a173976CA11'));
        expect(optimism.rpcUrls, isNotEmpty);
        expect(optimism.blockExplorerUrls, contains('https://optimistic.etherscan.io'));
      });
      ...
      test('should have correct Base mainnet config', () {
        ...
        expect(base.multicallAddress, equals('0xcA11bde05977b3631167028862bE2a173976CA11'));
      ...
      test('should have correct Avalanche mainnet config', () {
        ...
        expect(avalanche.multicallAddress, equals('0xcA11bde05977b3631167028862bE2a173976CA11'));
